        ...
        match meddelande_mottaget:
            case "KART":
                ...
                for i in range(0,len(target_list),2):
                    ...
                    current_ultraljud = get_ultraljud()
                    print("har kommit förbi ultraljudsläsning")
                ...
                if nodstopp == False or stopp == False:
                    AGV_riktning2 = AGV_riktning
                    error_pos = start_linjefoljare(q_IMU,AGV_riktning2)
                    print("AVSTÅND TILL BESÖKSPLATS:", error_pos)
                    ...
                    match AGV_riktning:
                        case 0:
                            ...
                            besok_pos_y = target_list[-1] + 30 #y-värde
                            mouse_x = mouse_x
                        ...
                        case 90:
                            print("CASE:90")
                            besok_pos_x = target_list[-2] + 30#x-värde av besökplats
                ...
                #SKICKA INTE POSITION FÖRÄNN VI HAR KÖRT IGENOM LINJEFÖLJNING
